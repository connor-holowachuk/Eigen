...
class RadialGraph: UIView, PassDataDelegate {
    ...
    override func drawRect(rect: CGRect) {
        ...
        let businesses = currentUser.advertisers
        let businessPayments: [Double] = currentUser.tripLog[passedIndex].paymentFromAdvertisers
        var businessPaymentsScaled: [Double] = [] //max is 0.8607309
        let numberOfBusinesses: Int = businesses.count
